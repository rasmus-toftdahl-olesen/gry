...
namespace gry
{
    ...
    public:
        ...
        void subscribeSecond ( ConnectionPtr _conn );
        void subscribeMinute ( ConnectionPtr _conn );
        void subscribeHour ( ConnectionPtr _conn );
        void subscribeDay ( ConnectionPtr _conn );
